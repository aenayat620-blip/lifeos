    ...
    <div className="p-4 pt-safe">
      ...
      <div className="flex flex-col items-center mb-8">
        <div className="relative w-40 h-40">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span className="text-xs text-zinc-500">از {target} ml</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        {[250, 500, 750, 1000].map((ml) => (
          <button key={ml} onClick={() => add(ml)} className="py-4 rounded-2xl bg-primary-50 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 font-medium text-lg">
            +{ml} ml
          </button>
        ))}
      </div>
