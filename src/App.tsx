      ...
      case 'nutrition':
        return (
          <div className="p-4 text-center text-zinc-500 mt-20">
            <p className="text-lg">این بخش به زودی تکمیل می‌شود</p>
            <p className="text-sm mt-2">معماری آماده است و داده‌ها ذخیره می‌شوند</p>
            <button onClick={() => setPage('home')} className="mt-4 px-4 py-2 bg-primary-600 text-white rounded-xl">بازگشت به خانه</button>
          </div>
        )
      default:
        return <Dashboard onNavigate={setPage} />
